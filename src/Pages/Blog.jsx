...
const Blog = () => {
    return (
        <div className='md:w-4/5 mx-auto'>
            <div className="card md:w-3/5 mx-auto my-4 bg-base-100 shadow-xl">
                <div className="card-body">
                    <h2 className="card-title text-green-400">Tell us the differences between uncontrolled and controlled components</h2>
            ...
            <div className="card md:w-3/5 mx-auto my-4 bg-base-100 shadow-xl">
                <div className="card-body">
                    <h2 className="card-title text-green-400">How to validate React props using PropTypes?</h2>
            ...
            <div className="card md:w-3/5 mx-auto my-4 bg-base-100 shadow-xl">
                <div className="card-body">
                    <h2 className="card-title text-green-400">Tell us the difference between nodejs and express js.</h2>
            ...
            <div className="card md:w-3/5 mx-auto my-4 bg-base-100 shadow-xl">
                <div className="card-body">
                    <h2 className="card-title text-green-400">What is a custom hook, and why will you create a custom hook?</h2>
